...
go
if OBJECT_ID('dbo.sp_draw_analyser_step2_sub2') is not null
begin
    drop procedure dbo.sp_draw_analyser_step2_sub2
    if OBJECT_ID('dbo.sp_draw_analyser_step2_sub2') is not null
        print '<<< FAILED DROPPING PROCEDURE dbo.sp_draw_analyser_step2_sub2 >>>'
    else
        print '<<< DROPPED PROCEDURE dbo.sp_draw_analyser_step2_sub2 >>>'
end
go

--------------------------------------------------------

create procedure dbo.sp_draw_analyser_step2_sub2
    @in_course_uid smallint,
    @in_distance_yard smallint,
    @in_adjusted_draw_prefix char(1),
    @in_sr_code char(1)
...
if OBJECT_ID('dbo.sp_draw_analyser_step2_sub2') is not null
    print '<<< CREATED PROCEDURE dbo.sp_draw_analyser_step2_sub2 >>>'
else
    print '<<< FAILED CREATING PROCEDURE dbo.sp_draw_analyser_step2_sub2 >>>'
go
grant execute on dbo.sp_draw_analyser_step2_sub2 to level1
go
...
go
if OBJECT_ID('dbo.sp_draw_analyser_step2') is not null
begin
    drop procedure dbo.sp_draw_analyser_step2
    if OBJECT_ID('dbo.sp_draw_analyser_step2') is not null
        print '<<< FAILED DROPPING PROCEDURE dbo.sp_draw_analyser_step2 >>>'
    else
        print '<<< DROPPED PROCEDURE dbo.sp_draw_analyser_step2 >>>'
end
go
create procedure dbo.sp_draw_analyser_step2
as
...
begin
    ...
    exec sp_draw_analyser_step2_sub1 @c_course_uid, @c_distance_yards, @c_adjusted_draw_prefix, @c_sr_code

    --update da_course_distance_data5; slope and intercept
    --select 'start sub2', getdate()
    exec sp_draw_analyser_step2_sub2 @c_course_uid, @c_distance_yards, @c_adjusted_draw_prefix, @c_sr_code

    --update da_course_distance_data5; r_square
    --select 'start sub3', getdate()
    exec sp_draw_analyser_step2_sub3 @c_course_uid, @c_distance_yards, @c_adjusted_draw_prefix, @c_sr_code

    --update da_course_distance_data5; pound and formula
    --select 'start sub4', getdate()
    exec sp_draw_analyser_step2_sub4 @c_course_uid, @c_distance_yards, @c_adjusted_draw_prefix, @c_sr_code
...
go
if OBJECT_ID('dbo.sp_draw_analyser_step2') is not null
    print '<<< CREATED PROCEDURE dbo.sp_draw_analyser_step2 >>>'
else
    print '<<< FAILED CREATING PROCEDURE dbo.sp_draw_analyser_step2 >>>'
go
grant execute on dbo.sp_draw_analyser_step2 to level1
go
