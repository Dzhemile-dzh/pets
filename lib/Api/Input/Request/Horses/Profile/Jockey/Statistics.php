    ...
    protected function setupParameters()
    {
        ...
        $this->addOrderedParameter(
            ...
            new StandardValidator\ExistsInArray(
                $this->getSelectors()->getStatisticsTypeCodeKeys('jockey')
            ),
            false,
            'course'
        );
        ...
        $this->addValidator(new \Api\Input\Request\Validator\SeasonalStatisticsParamsCombinations($this->getSelectors(), 'jockey'));
