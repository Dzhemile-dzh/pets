...
class Sire extends GeneralSeason
{

    const SEASONAL_STATS_KEY = 'sire';
    ...
    protected function setupParameters()
    {
        ...
        $this->addNamedParameter(
            'championship',
            new StandardValidator\ExistsInArray([self::SEASONAL_STATS_KEY]),
            false
        );
        ...
        $this->addCast('firstCrop', new Cast\Boolean());
        ...
        $this->addNamedParameter(
            'raceGroupId',
            new StandardValidator\ArrayParameter(new StandardValidator\Integer()),
            false
        );
        $this->addCast('raceGroupId', new Cast\Collection(new Cast\DecimalInteger()));
        ...
        $this->addValidator(new RaceTypeValidator(RaceTypeValidator::FIRST_CROP | RaceTypeValidator::G1_WINNER | RaceTypeValidator::JUMPS_CODE));
