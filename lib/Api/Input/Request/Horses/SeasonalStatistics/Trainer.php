...
class Trainer extends GeneralSeason
{

    const SEASONAL_STATS_KEY = 'trainer';
    ...
    protected function setupParameters()
    {
        ...
        $this->addNamedParameter(
            'championship',
            new Validator\TrainerChampionship(
            ),
            false,
        ...
        $this->addValidator(new RequestValidator\RaceDistances($this->getSelectors(), $this->getRaceType()));
    }
}
