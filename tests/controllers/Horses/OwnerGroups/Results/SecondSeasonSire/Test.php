...
namespace Tests\Controllers\Horses\OwnerGroups\Results\SecondSeasonSire;
...
class Test extends ApiRouteTestPrototype
{
    ...
    {
        return '/horses/owner-groups/results/second-season-sire/coolmore';
    }
    ...
    {
        return [
            //Api\DataProvider\Bo\OwnerGroups\Results:138 ->getData()
            'ada57fc77cd49d2c687595799c70db5e' => [
                [
