...
namespace Tests\Controllers\Horses\Results\Date\Limited;
...
class Test extends ApiRouteTestPrototype
{
    ...
    public function getRoute(): string
    {
        ...
        return "/horses/results/date/$date/limited";
    }
    ...
    public function getPseudoPdoData(): array
    {
        return [
            ...
            '578e45c9cf6c602e3248b36524b8c94c' => [
                [
            ...
            'ae16d6d36b5d447861de336c37e6c168' => [
                [
                    'race_instance_uid' => 695416,
                    'stake' => 1.4325
                ]
            ...
            //Models\Bo\Results\RaceInstance:415 ->getRaceListByDate()
            '04e9a8b25614d43db1de2d26e0b821e2' => [
                [
                    'race_instance_uid' => 695416,
            ...
            '7a81a8893d9a82c019003532d65ae929' => [
            ],
            ...
            '92a5d0575d0dbf64afaf860c6bcf5b0f' => [
                [
                    'race_instance_uid' => 695416,
                    'race_status_code' => 'R',
            ...
            //Models\Bo\Results\RaceInstance:150 ->getTote()
            '721fb5621c464bdbb974bec51958448f' => [
                [
                    'race_instance_uid' => 695416,
            ...
            '20624b8941946097d29c73530a1a62b7' => [
                [
                    'horse_uid' => 1018540,
                    'race_instance_uid' => 695416,
                    'race_status_code' => 'R',
            ...
            'f1f068b619226f25482e2a54b10a48e7' => [
                [
                    'race_instance_uid' => 695416,
                    'rule4_text' => null,
                ]
            ...
            '256dbce082f2d2c1608ba73550e8b365' => [
                [
                    'race_instance_uid' => 695416,
                    'horse_uid' => 868799,
            ...
            'c6b3d86873219f9f2bb72366e6dda4cd' => [
                [
                    'horse_uid' => 1353019,
                    'owner_group_uid' => 5,
                    'to_follow_uid' => null
            ...
            '4f43d557fea0cb4cf618b70c63a22ac6' => [
                [
                    'course_uid' => 394,
            ...
            '2a17bc1b8a2af30ccc2655cdf05cb2bc' => [
                [
                    'course_uid' => 394,
                    'race_instance_uid' => 695416,
                    'race_datetime' => '2018-03-02 13:45:00',
            ...
            '044d64452499eda0bd43c58c50bb2510' => [
                [
                    'course_uid' => 206,
                    'betting_man' => ' ',
                    'analysis_man' => ' ',
            ...
            //Models\Course:821 ->getMeetingsStatus()
            'd846c71d935403b66027f2c8b43da7c3' => [
                [
                    'course_uid' => 394,
                    'total_prize_money' => 35123.90,
                    'no_of_unfinished_races' => 0,
                ],
            ],
        ];
    }
