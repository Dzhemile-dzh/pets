...
namespace Tests\Controllers\Horses\Results\Date\AllRaces;
...
class Test extends ApiRouteTestPrototype
{
    ...
    {
        return '/horses/results/date/2018-03-02/all-races';
    }
    ...
    {
        return [
            //Models\Bo\Results\RaceInstance:257 ->getRaceListByDate()
            '0c9d2fdf138af1be3a5f4c870f1850a0' => [
                [
            ...
            'b3ac7a6c383d5f28377eef281d27ce6b' => [
                [
                    'horse_uid' => 1018540,
                    'race_instance_uid' => 695416,
                    'race_status_code' => 'R',
            ...
            'b2aae8ab91c58f0767f4012d42941821' => [
                [
                    'course_uid' => 394,
                    'race_instance_uid' => 695416,
                    'race_datetime' => '2018-03-02 13:45:00',
            ...
            '69e6ad5774acf1f15da26fb0685da113' => [
                [
                    'course_uid' => 206,
                    'betting_man' => ' ',
                    'analysis_man' => ' ',
