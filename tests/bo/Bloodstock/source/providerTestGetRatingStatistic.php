...
$methods = [
    'getCountryFlag' => 'GB-IRE',
    'getSeasonYearBegin' => 2016,
    'getSeasonDateBegin' => 'Apr 26 2015 12:00AM',
    'getSeasonYearEnd' => 2016,
    'getSeasonDateEnd' => 'Apr 23 2016 11:59PM',
    'getRaceType' => 'flat',
    'getSurface' => 'turf'
];
$methodNames = array_keys($methods);
$stub = $this->getMockBuilder('\Api\Input\Request\Horses\Bloodstock\Statistics\Rating')
    ->disableOriginalConstructor()
    ->setMethods($methodNames)
    ->getMock();

// Configure the stub.
foreach ($methods as $methodName => $methodResult) {
