...
use Tests\Stubs\Bo\TotePredictor\Meeting;
 ...
 * @package Tests\Bo
 */
class MeetingTest extends \PHPUnit\Framework\TestCase
{
    /**
     ...
     */
    public function testGetData(Request $request, General $expectedResult)
    {
        $bo = new Meeting($request);
    ...
    public function providerTestGetData()
    {
        return [
            [
                new Request([], ['date' => '2017-11-27', 'courseId' => 3]),
