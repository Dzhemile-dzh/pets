...
class FeeHistory extends \Api\DataProvider\Bo\Bloodstock\Stallion\FeeHistory
{
    /**
     * @param HorsesRequest $request
     *
     * @return \Api\Row\Bloodstock\Stallion\FeeHistory[]
     */
    public function getFeeHistory(HorsesRequest $request)
    {
        ...
        return $data[$request->getStallionId()];
    }
}
