...
namespace Tests\Stubs\DataProvider\Bo\Profile\Jockey;

use Api\Input\Request\HorsesRequest as Request;

/**
 * Class SeasonsAvailable
 * @package Tests\Stubs\DataProvider\Bo\Profile\Jockey
 */
class SeasonsAvailable extends \Api\DataProvider\Bo\Profile\Jockey\SeasonsAvailable
{
    /**
     * @param $request
     *
