...
use \Api\Input\Request\Validator\OneSeasonBeginEndYears as Validator;

class OneSeasonBeginEndYearsTest extends \PHPUnit\Framework\TestCase
{
    /**
    ...
    public function dataProviderTestException()
    {
        return [
            ...
            [['getSeasonYearBegin' => 1999, 'getSeasonYearEnd' => 2001]],
        ];
    }
