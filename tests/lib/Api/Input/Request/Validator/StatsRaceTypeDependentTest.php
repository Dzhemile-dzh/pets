...
use \Api\Input\Request\Validator\StatsRaceTypeDependent as Validator;

class StatsRaceTypeDependentTest extends \PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        return [
            [['getRaceType' => 'flat', 'getStatisticsTypeCode' => 'race-category']],
            [['getRaceType' => 'jumps', 'getStatisticsTypeCode' => 'age-of-horse']],
        ];
    }
    ...
    {
        return [
            [['getRaceType' => 'jumps', 'getStatisticsTypeCode' => 'race-category']],
            [['getRaceType' => 'flat', 'getStatisticsTypeCode' => 'age-of-horse']],
        ];
    }
}
