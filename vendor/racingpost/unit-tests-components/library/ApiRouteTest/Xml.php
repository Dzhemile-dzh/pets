...
abstract class Xml extends ApiRouteTestPrototype
{
    /**
     * @param $ctrl
     * @param $obj
    ...
    {
        $this->assertControllerResultEqualsXml($controller, $stubData);
    }

    public function getExpected(): string
    {
        $reflector = new \ReflectionClass(get_class($this));
        $file = dirname($reflector->getFileName()) . '/expected.xml';
        if (!file_exists($file)) {
